...
//false = Watts
    ...
    /// </summary>
    public static double CalculateCostOfPurchasingX(double n, double b, double m, double l)
    {
    ...
    /// </summary>
    public static int CalculateMaxAffordable(double c, double b, double m, double l)
    {
